...
describe('http-mock', function() {
    ...
    directoriesData.groups = _groups._setAll([
        {id: 3, name: 'Автосайт'},
        {id: 2, name: 'Автосалон'},
    ...
    directoriesData.managers = _managers._setAll([
        {id: 1, name: 'Катя'},
        {id: 2, name: 'Инна'},
        {id: 4, name: 'Потеряшки'},
        {id: 0, name: ''}
    ...
    directoriesData.cities = _cities._setAll([
    ...
    directoriesData.markets = _markets._setAll([
        {id: 7, name: 'Рынок один', _city: {id: 6}},
        {id: 8, name: 'Рынок два', _city: {id: 5}}
    ]);
    ...
    directoriesData.metros = _metros._setAll([
        {id: 9, name: 'Метро один', _city: {id: 5}},
        {id: 10, name: 'Метро два', _city: {id: 6}}
    ]);
    ...
    directoriesData.sites = _sites._setAll([
