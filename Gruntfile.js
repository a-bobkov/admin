module.exports = function(grunt) {
    ...
    grunt.registerMultiTask('admin', 'Create admin.html', function() {
        ...
        var base = (this.target === 'dev') ? '' : '<base href="/fend/admin.html#/">';
        ...
        grunt.file.write('web/admin.html', grunt.template.process(grunt.file.read('web/admin.html.tmpl'), {
            data: {
                ...
                hashScreen: fileHash('../maxposter1/web/css/blueprint/screen.min.css', this.target),
                hashPrint: fileHash('../maxposter1/web/css/blueprint/print.min.css', this.target),
                hashIE: fileHash('../maxposter1/web/css/blueprint/ie.min.css', this.target),
